...
class User(AbstractUser):
    ...
    avatar = models.ImageField(max_length=255, upload_to="avatar/%Y/%m/%d", blank=True,)
    gender = models.CharField(
        choices=Constant.GENDER_CHOICES, max_length=10, blank=True,
    )
    ...
    login_method = models.CharField(
        max_length=50, choices=Constant.LOGIN_CHOICES, default=Constant.LOGIN_EMAIL,
    )
